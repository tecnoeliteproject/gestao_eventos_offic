...
import 'package:gestao_eventos/data/datasources/remoto/firebase/firebase_material_datasource.dart';
...
import 'package:gestao_eventos/data/repositories/material_repository.dart';
...
import 'package:gestao_eventos/domain/usecases/material_usecase.dart';
...
Future<void> setupGetIt() async {
  getIt
    ...
    ..registerLazySingleton<IMaterialDatasource>(
      FirebaseMaterialDatasource.new,
    )
    ..registerLazySingleton<IMaterialRepository>(
