...
class CanversationsPage extends StatefulWidget {
  CanversationsPage({Key? key}) : super(key: key);

  @override
  _CanversationsPageState createState() => _CanversationsPageState();
}

class _CanversationsPageState extends State<CanversationsPage> {
  @override
  void initState() {
    super.initState();
    initDependencies();
